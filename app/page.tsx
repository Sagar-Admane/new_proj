  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="flex justify-center">
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-primary/20">
                {/* <Image
                  ...
                  priority
                /> */}
                <img src="/anushk1.jpg"  alt="Anushka Singh Raghuvanshi" />
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Experience Section */}
        <section id="experience" className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24 bg-muted/50">
        ...
        {/* Education Section */}
        <section id="education" className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        {/* Skills Section */}
        <section id="skills" className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24 bg-muted/50">
        ...
        <section id="certifications" className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        {/* Projects Section */}
        <section id="projects" className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24 bg-muted/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="overflow-hidden">
              <div className="relative h-48">
                <Image 
                  src="https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" 
        ...
        <section id="achievements" className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        {/* Contact Section */}
        <section id="contact" className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24 bg-muted/50">
